...
backup_recv_raw_log = get_logger('recv_raw', fileName='receive_raw.csv', backup_data=True, working=LoggerParam.backup_send_raw and LoggerParam.backup,maxBytes=20*1024*1024)
